...
relevantProcs.append("3768") #PVAD


#### Make File to pull demographics

Question = open("percutaneous-vad.ASC", 'w')
BadLines = open("percutaneous-vadBadLines.ASC", 'w')
comorb = open("percutaneous-vadComorbidities.ASC", 'w')
